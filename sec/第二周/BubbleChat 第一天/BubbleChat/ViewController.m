...
//    if (offSet>_tableView.contentSize.height-(_tableView.frame.size.height-64-(568-rect.origin.y))) {
//        offSet = _tableView.contentSize.height-(_tableView.frame.size.height-64-(568-rect.origin.y));
//    }
    
    if (_tableView.contentSize.height>(568-rect.origin.y)) {
